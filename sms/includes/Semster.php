...
class Semster{
    ...
    public function create() {
		global $database;
		$sql1="CREATE TABLE $this->id ( index_no int( 8 ) ,sub_id varchar( 50 ),
		mark INT ,grade CHAR( 2 ) ,
		mark2 INT ,grade2 CHAR( 2 ) ,
		mark3 INT ,grade3 CHAR( 2 )	,
		mark4 INT ,grade4 CHAR( 2 ) ,
		mark5 INT ,grade5 CHAR( 2 ) ,
		mark6 INT ,grade6 CHAR( 2 ), PRIMARY KEY ( index_no, sub_id ))";
