		  ...
		  <table id="structure">
				<tr>
					<td id="navigation">
	  				...
	  				<td id="page">
						<div id="whtbox">
						<img src="images/login.png" style="width:600px;height:380px;margin:80px;padding-left:100px;border-radius: 10px 10px 10px 10px;">
						</div>
					</td>
					<td id="logindetails">
						 <div id="form">
                         <form action="login.php" method="post" name="login">
							<table id="t1" >
								...
								<tr class="style-1 clearfix">
                                	<td id="username">Username:</td>
									<td><input class="focus" type="text" name="username" maxlength="30" value="<?php
									echo htmlentities($username); ?>"/></td>
								</tr>
								<tr class="style-1 clearfix">
									<td>Password:</td>
									<td><input class="focus" type="password" name="password" maxlength="30" value="<?php
							...
							<table>
								...
								<tr>
									<td>
										<input class="button_example" type="reset" value= "    Reset    "/>
									</td>	
									<td>
									  <input class="button_example" type="submit" name="submit" value="     Login   " />
