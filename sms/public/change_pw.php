				...
				<tr>
					...
					<td id="page">
						<h2>Change password</h2>
						 <form id="user_form" action="change_pw.php" method="post" >
							<table id="form2" width="100%">
								...
								<tr>
									<td colspan="3"><input type="submit" class="button_example" name="submit" value="Change password" />
									</td>
					...
					<td id="logindetails">
						<div class="details">
						<img class="logpic" src="images/user.jpg" style="width:150px;height:150px;">
						<h4>Login Details</h4>
						<?php
