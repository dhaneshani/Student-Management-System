				...
				<tr>
					...
					<td id="page">
						...
						<?php //if(!empty($message)){echo "<p class=\"message\">".$message."</p>";} ?>
						 ...
						 <form id="studentform" action="add_subject.php" method="post" >
							<table id="form2" width="100%">
                                
                                <?php //echo $message; ?>
								<tr>
									<td id="s_id">Subject ID:</td>
									<td id="s_id"><input type="text" name="s_id" id="s_id" maxlength="50" size="50" placeholder="Ex: SCS1001"/></td>
									<td><h6><?php if(isset($errors['s_id'])) echo $errors['s_id']; ?></h6></td>
								</tr>
								<tr>
									<td id="s_name" >Subject Name:</td>
									<td id="s_name" ><input type="text" name="s_name" id="s_name" maxlength="50" placeholder="Subject name"/></td>
								 ...
								 <tr>
										<td>Semster ID:</td>
										<td id="sem_id" ><input type="text" name="sem_id" id="sem_id" maxlength="50" placeholder="semester ID"/></td>
                                 ...
                                 <tr>
								  ...
								  <tr>
										...
										<td id="credits" ><input type="text" name="credits" id="credits" maxlength="50" placeholder="num of credits"/></td>
									<td><h6><?php if(isset($errors['credits'])) echo $errors['credits']; ?></h6></td>
								</tr>

								<tr>
									<td colspan="2"><input type="submit" class="button_example" name="submit" value="Add subject" />
									</td>
