...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $id9=$batch.$course.$sem5.$id4;
			$result = mysql_query("SHOW TABLES LIKE '$id9'");
			$tableExist5 = mysql_num_rows($result) > 0;
			
		$id10=$batch.$course.$sem6.$id4;
			$result = mysql_query("SHOW TABLES LIKE '$id10'");
		...
		if(empty($errors)&&$tableExist1&&$tableExist2&&$tableExist3&&$tableExist4&&$tableExist5&&$tableExist6){			
			...
			$rslt=$new_overallgpa->calculate_finalGPA();
				...
				<tr>
					...
					<td id="page">
						...
						<?php //if(!empty($message)){echo "<p class=\"message\">".$message."</p>";} ?>
						 ...
						 <form id="user_form" action="cal_final_gpa.php" method="post" >
