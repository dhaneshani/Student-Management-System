					...
					<td id="page">
                        <table>
                            <tr><?php
                                ...
                                <?php
									...
									foreach ($arr as $sub){
										$name=User::find_by_staff_id($sub->staff_id);
                                        echo "<tr><td>$sub->staff_id</td><td>";
										echo $name->name;
										echo "<a href='unallocate.php?staff_id=$sub->staff_id&sub_id=$subject_id'  class='button_example'>Unallocate lecture</a></td></tr>";
						...
						<table>
							...
							<tr>
								...
								<td colspan="2"><input type="submit"  class="button_example" name="submit" value="Assign Lecturer" /></td>
