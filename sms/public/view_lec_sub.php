						...
						<table>
								...
								$arr=Subject::find_sub_by_lec($staff_id);
									...
									foreach ($arr as $sub){
										...
										echo "<a href='input_batch.php?sub_id=$sub->sub_id' class='button_example'>Enter exam Results</a></td><td>";
										echo "<a href='enter_index.php?sub_id=$sub->sub_id' class='button_example'>Repeat exams' Results</a></td></tr>";
